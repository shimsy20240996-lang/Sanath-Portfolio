      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {profileData.coreCompetencies.map((skill, index) => (
          <motion.div
            ...
            className="bg-white dark:bg-slate-800 rounded-lg p-4 shadow-sm border border-gray-100 dark:border-gray-700"
          >
            ...
            <div className="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-2">
              <div 
                className="bg-navy dark:bg-gold h-2 rounded-full" 
